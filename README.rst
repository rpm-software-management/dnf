...
Please, do not create the pull requests with translation (.po) files iprovements. Fix the translation on `Zanata <https://fedora.zanata.org/iteration/view/dnf/master>`_ instead.
