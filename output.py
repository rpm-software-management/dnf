...
def failureReport(msg, errorlog=None, relative=None):
...
def rssnode(node, escape, pkg):
    """return an rss20 compliant item node
       takes a node, escape function for the doc and a pkg object"""
