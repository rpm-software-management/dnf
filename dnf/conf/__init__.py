...
from dnf.yum.misc import read_in_items_from_dot_dir
...
class Conf(BaseConfig):
    ...
    def __init__(self, section='main', parser=None):
        super(Conf, self).__init__(section, parser)
...
class RepoConf(BaseConfig):
    ...
    def __init__(self, parent, section=None, parser=None):
        ...
        self.add_option('protected_packages',  Inherit(parent.get_option('protected_packages'))) # :api
