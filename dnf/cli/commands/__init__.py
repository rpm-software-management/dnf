...
class InfoCommand(Command):
    ...
    usage = "[%s|all|available|installed|updates|extras|duplicates|installonly|autoerase|problems|obsoletes|recent]" % _('PACKAGE')
    ...
    def parse_extcmds(extcmds):
        ...
        pkgnarrows = {'available', 'installed', 'extras', 'upgrades',
                      'duplicates', 'installonly', 'autoerase', 'problems',
