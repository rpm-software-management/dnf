...
Reversion to Yum's configuration directive :ref:`includepkgs <include-label>` and :ref:`excludepkgs <exclude-label>`
====================================================================================================================

Due to better compatibility with yum DNF's conf directive ``include`` was
was replaced with origin conf directive ``includepkgs``. Same for conf
directive ``includepkgs``.
...
Installation of optional packages of group is changed from subcommand ``with-optional`` to parameter ``--with-optional``.
